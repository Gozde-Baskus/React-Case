...
import BrandFilter from "./components/filters/BrandFilter.jsx";
...
test("ListPage Filter", () => {
  render(<ListPage />);
  const linkElement = screen.getByText(/No items in the basket/i);
  expect(linkElement).toBeInTheDocument();
});